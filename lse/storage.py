...
class TraceStorage:
    ...
    def _generate_filename(self, run_id: Union[str, UUID], timestamp: Optional[datetime] = None) -> str:
    ...
    def _create_summary_file(
        ...
        try:
            ...
            summary_data = {
                ...
                "failures": [{"run_id": str(run_id), "error": error} for run_id, error in failed_saves],
            }
